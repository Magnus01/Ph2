<?php
    ...
    if(isset($_POST['titlez'])&&isset($_POST['commentz'])){
        ...
        $Model->addCourse($title, $description, $User_id);
...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" media="all" href="./vendors/bootstrap/dist/css/bootstrap.css">
    ...
    <!-- jVectorMap -->
    <link href="./js/production/css/maps/jquery-jvectormap-2.0.3.css" rel="stylesheet"/>
    <!-- Custom Theme Style -->
...
<body class="nav-md">
              ...
              <div class="left_col scroll-view">
                ...
                <div class="profile">
                  <div class="profile_pic">
                    <img src="./js/production/images/img.jpg" alt="..." class="img-circle profile_img">
                  </div>
    ...
    <!-- Flot plugins -->
    <script src="./js/production/js/flot/jquery.flot.orderBars.js"></script>
    <script src="./js/production/js/flot/date.js"></script>
    <script src="./js/production/js/flot/jquery.flot.spline.js"></script>
    <script src="./js/production/js/flot/curvedLines.js"></script>
    <!-- jVectorMap -->
    <script src="./js/production/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="./js/production/js/moment/moment.min.js"></script>
    <script src="./js/production/js/datepicker/daterangepicker.js"></script>

    <!-- Custom Theme Scripts -->
    <script src="./js/build/js/custom.min.js"></script>

    <!-- jVectorMap -->
    <script src="./js/production/js/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="./js/production/js/maps/jquery-jvectormap-us-aea-en.js"></script>
    <script src="./js/production/js/maps/gdp-data.js"></script>
