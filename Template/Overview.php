        ...
        <div class="row">                      
								...
								<div class="6u 12u$(small)">
									<ul class="actions fit">
										<li><a href="Code1.html" class="button alt fit">Code 1</a></li>
										<li><a href="#" class="button fit">Question 2</a></li>
										
									</ul>
								</div><div class="6u 12u$(small)">
									<ul class="actions fit">
										<li><a href="code3.html" class="button alt fit">Code 3</a></li>
										<li><a href="codePHP.php" class="button fit">Code PHP (Download test)</a></li>
	...
	<div class="container" >
        ...
        <div class="row">                      
								...
								<div class="6u 12u$(small)">
									...
									<ul class="actions fit">
										<li><a href="Chapter2/C2Q3.php" class="button alt fit">Question 3</a></li>
										<li><a href="Chapter2/C2Q4.php" class="button fit">Question 4</a></li>
						...
						<div class="container" >
        					...
        					<div class="row">
								...
								<div class="6u 12u$(small)">
									<ul class="actions fit">
										<li><a href="Chapter3/C3Q1.php" class="button alt fit">Question 1</a></li>
										<li><a href="Chapter3/C3Q2.php" class="button fit">Question 2</a></li>
									</ul>
								</div><div class="6u 12u$(small)">
									<ul class="actions fit">
										<li><a href="Chapter3/C3Q3.php" class="button alt fit">Question 3</a></li>
										<li><a href="Chapter3/C3Q4.php" class="button fit">Question 4</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="container" >
								...
								<div class="row">
									...
									<div class="6u 12u$(small)">
										<ul class="actions fit">
											<li><a href="Chapter4/C4Q1.php" class="button alt fit">Question 1</a></li>
											<li><a href="Chapter4/C4Q2.php" class="button fit">Question 2</a></li>
										</ul>
									</div><div class="6u 12u$(small)">
										<ul class="actions fit">
											<li><a href="Chapter4/C4Q3.php" class="button alt fit">Question 3</a></li>
											<li><a href="Chapter4/C4Q4.php" class="button fit">Question 4</a></li>
										</ul>
									</div>
								</div>
		...
		<!-- Footer -->
			...
			<?php     echo '<script> var test1 = document.getElementById(\'titre\');  
