...
describe("Cahpter 3 IndexOf question", function(){
    ...
    describe("Test IndexOf function ", function() {
        ...
        it("Check if indexOf was used", function () {
           var sumStr = Check.check.toString().replace(/ /g,'');
           var sumStr = sumStr.replace(/(\r\n|\n|\r)/gm,"");
           expect(sumStr).toContain("return");
           expect(sumStr).toContain("indexOf");
           expect(sumStr).toContain("welcome");
        });
